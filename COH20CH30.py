...
def main():
    ...
    num_of_functional_COH = int(len(carbontube[bool_wall]) * 0.1)     ## 3600 * 20% = 720
    num_of_functional_CH = int(len(carbontube[bool_wall]) * 0.1)     ## 3600 * 30% = 1080
